...
namespace app\backend\modules\joinin\controllers;
...
/**
 * Default controller for the `joinin` module
 */
class DefaultController extends BaseController
{
    ...
    public function actionIndex()
    {
        ...
        $model = TJoinin::getList(TJoinin::search($params),$pageIndex,$this->pageSize);
    ...
    public function actionDelete()
    {
        ...
        if(TJoinin::findOne($this->data['params']['id'])->delete()){
    ...
    public function actionBatchDel()
    {
        ...
        foreach($banners_id as $v){
            $model = TJoinin::findOne($v)->delete();
        }
    ...
    public function actionHandle(){
        ...
        $this->data['id'] = $id;
        $this->data['row'] =  TJoinin::findOne($id);
        if($post){
            $model = TJoinin::findOne($post['id']);
