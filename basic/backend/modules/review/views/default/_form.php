<form action="?r=review/default/<?php echo $action; ?>" class="form-horizontal" id="validation-form"
      method="post">
    ...
    <div class="form-body form1 show">
            ...
            <?php if(isset($row['id'])){?>
                <input type="hidden" class="form-control" name="Review[id]" id="banner_id" value="<?php echo $row['id'];?>">
            <?php }?>
        <div class="form-group">
            ...
            <div class="col-md-4">
                <input type="text" id="name" name="Review[title]" class="form-control"
        ...
        <div class="form-group">
            ...
            <div class="col-md-4">
                                <textarea class="form-control" rows="3"
                                          name="Review[summary]"><?php echo isset($row['summary']) ? $row['summary'] : ''; ?></textarea>
            </div>
        </div>
        <div class="form-group ">
            ...
            <div class="col-md-9">
                <div class="fileinput fileinput-new" data-provides="fileinput">
                    ...
                    <div>
                        ...
                        <input type="file" name="Review[cover_img]" id="img_url"> </span>
                        <input type="hidden" name="Review[cover_img]" value="<?php echo isset($row['cover_img'])?$row['cover_img']:''; ?>">
    ...
    <div class="form-body">
        <div class="form-group">
            ...
            <div class="col-md-1">
                <input type="text" name="Review[sort]" id="sort" class="form-control"
