        ...
        validate(
            {
                ...
                'Case[logic_desc]':{'required':true},
                'Case[case_type]':{'required':true},
            },
            {
                'Rule[name]':{'required':'规格名称不能为空'},
                'Val[val_name][]':{'required':'值不能为空'},
                'Rule[p_order]':{'required':'规格的排序不能为空'},
                'Val[p_order][]':{'required':'规格值的排序不能为空'},
                'Case[business_desc]':{'required':'事故业务分析不能为空'},
                'Case[logic_desc]':{'required':'事故系统逻辑不能为空'},
            },
        );
    },
