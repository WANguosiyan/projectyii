...
var fnImageCropRot = function(o){
    //o为图片对象
    if(typeof(o) === "object" && o.tagName.toLowerCase() === "img"){//检测是否是图片类型的DOM对象
        //当前显示图片的高度和宽度
