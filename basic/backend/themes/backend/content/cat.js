...
validate(
    {
        'Cate[cat_name]':{'required':true},
        'Cate[p_order]':{'required':true,min:1}
    },
    {
        'Cate[cat_name]':{'required':'分类名不能为空'},
        'Cate[p_order]':{'required':'排序不能为空','min':'排序至少为1'}
    }
);
